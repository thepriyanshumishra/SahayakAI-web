...
function VolunteerDashboard() {
  ...
  return (
    <div className="page-content" style={{ maxWidth: 1000, margin: '0 auto', paddingTop: 40 }}>
      {/* HEADER SECTION */}
      <motion.div 
      ...
      {!isPhoneVerified && (
        <motion.div 
          ...
          style={{ background: 'var(--priority-medium-bg)', border: 'none', padding: '24px 32px' }}
        >
          <div style={{ 
      ...
      {/* TASK FEED */}
      <div className="flex justify-between items-center mb-8" style={{ marginTop: 60 }}>
